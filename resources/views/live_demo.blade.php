   ...
   <div class="container">
      <div class="row">
         <div class="col-md-6 col-sm-6">
            <h2 style="color:#fff">Book For demo</h2>
         </div>
         <div class="col-md-6 col-sm-6 hidden">
            <ul class="breadcrumb pull-right" style="background:transparent;    float: right;margin-bottom: 0px;">
               ...
               <li><a href="{{ url('program')}}" style="color:#fff">Book For demo</a></li>
               <li style="color:#fff;font-size:12px;"> <i class="fas fa-angle-double-right" style="vertical-align: -webkit-baseline-middle;   padding: 0 5px;"></i> </li>
                     ...
                     <div class="row">
                        ...
                        <div class="col-lg-8">
                           ...
                           <div class="cd-review-form mt-4 mb-4" style="border: 5px double #0051DE;padding: 30px;">
                              <h3 class="c-overview-title" style="border-bottom: 1px solid #0051DE;">Book For demo</h3>
                              <form id="live_demo_update"  action="{{ url('live_demo_update') }}" method="post" >
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                       ...
                                       <br/>
                                       <input type="hidden" name="transaction_type" value="Book for demo">
                                       <input type="text" name="program_price" value="Free" placeholder="Enter Amount (Rs.)" readonly >
                                    </div>
                                    <div class="col-md-6">
                                       <label>Available Slot <span class="red">*</span></label>
                                       <br/>
                                       <select class="form-control" name="available_slot" required>
