                           ...
                           <table id="example" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="example_info">
                              <thead>
                                 <tr role="row" style="text-align: center;">
                                    ...
                                    <th class="w-10p">Client Name</th>
                                    <th>Appointment Details</th>
                                  
                                    <th class="wd-15p">Fee </th>
                                    <th>Share of Kids Fable</th>
                                    <th>My Share </th>
                              ...
                              <tbody>
                                 ...
                                 <tr role="row" class="odd">
                                   ...
                                   <td>{{@$st_value->getslot->slot_date}} <br/> {{date('h:i A',strtotime(@$st_value->getslot->start_time))}}</td>
                                <td>{{$st_value->transaction}} INR</td>
                                    ...
                                    <td> <center><a href="{{url('download-invoice?id='.$st_value->id)}}" target="_blank" style="color:#2d3ad6;" ><i class="fa fa-download"></i></a></center></td>
                                 </tr>
                                 @endforeach
                              </tbody>
                           </table>
