			...
			<table class="inventory">
				<thead>
					<tr>
						...
						<th><span contenteditable>Date of purchase	</span></th>
				...
				<tbody>
					<tr>
						<td><a class="cut">-</a><span contenteditable>{{$payment->type}}</span></td>
						<td><span contenteditable>{{date('m F Y h:i A',strtotime($payment->created_at))}}</span></td>
