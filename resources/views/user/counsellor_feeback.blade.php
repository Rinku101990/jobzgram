   ...
   <div class="container">
      <div class="row" >
         <div class="col-md-6 col-sm-6">
            <h2 style="color:#fff">Counsellor Feeback</h2>
         </div>
         <div class="col-md-6 col-sm-6 hidden">
            <ul class="breadcrumb pull-right" style="background:transparent;    float: right;margin-bottom: 0px;">
               ...
               <li class="active"><a href="#" style="color:#fff">Counsellor Feeback</a></li>
            </ul>
         </div>
      </div>
   </div>
               ...
               <div class="aiz-user-panel">
                  ...
                  <div class="card">
                     <div class="card-header">
                        <h5 class="mb-0 h6"> Counsellor Feeback</h5>
                     </div>
                     <div class="card-body">
                     @if ($message = session()->has('errors_validation'))
                        ...
                        <form  action="{{ url('feedback_save') }}" method="post" >
                           {!! csrf_field() !!}
                           <input type="hidden" name="counsellor" value="{{ $counsellor->child_counsellor }}" />
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-md-12">
                              <h4>Counselor : {{ $counsellor->getcounsellor->name }}</h4>
                              </div>
