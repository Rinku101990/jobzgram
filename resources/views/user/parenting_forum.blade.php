...
.yl-breadcrumb-section {
      ...
      <!-- Start of breadcrumb section
         ...
         <section id="yl-breadcrumb" class="yl-breadcrumb-section position-relative" style="">
            ...
            <div class="row" >
               ...
               <h2 style="color:#fff">Parenting Forum</h2>
                </div>
                <div class="col-md-6 col-sm-6 hidden">
                    <ul class="breadcrumb pull-right" style="background:transparent;    float: right;margin-bottom: 0px;">
                       ...
                       <li class="active"><a href="#" style="color:#fff">Parenting Forum</a></li>
                                                                                            </ul>
                </div>
            </div>
    ...
    <div class="card-header">
            <h5 class="mb-0 h6">Parenting Forum</h5>
        </div>
     ...
     <hr>
     <br/>
     <a href="{{ url('parenting-tips')}}">
     <h3>Parenting Tips</h3>
       </a>
     <hr>
     <br/>
     <a href="{{ url('parenting-webinars')}}">
     <h3>Parenting Webinar</h3>
     </a>
     <hr>
