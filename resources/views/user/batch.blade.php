...
.yl-breadcrumb-section {
      ...
      <!-- Start of breadcrumb section
         ...
         <section id="yl-breadcrumb" class="yl-breadcrumb-section position-relative" style="">
            ...
            <div class="row" >
               ...
               <h2 style="color:#fff">Batch List</h2>
                </div>
                <div class="col-md-6 col-sm-6 hidden">
                    <ul class="breadcrumb pull-right" style="background:transparent;    float: right;margin-bottom: 0px;">
                       ...
                       <li class="active"><a href="#" style="color:#fff">Batch List</a></li>
                                                                                            </ul>
                </div>
            </div>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0 h6">Batch List</h5>
        </div>
        <div class="card-body">
                            ...
                            <table id="example" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="example_info">
                                ...
                                <tbody>
                                     ...
                                     <tr role="row" class="odd">
                                        ...
                                        <td><a href="{{url('student-list?batch='.$val->id)}}" style="color:#2d3ad6">{{$val->name}}</a></td>
                                                                               
                                        <td>{{date('d M, Y',strtotime($val->start_date)) }}</td>
                                        <td>{{date('d M, Y',strtotime($val->end_date)) }}</td>
                                          <td>{{$val->schedule}} - {{date('h:i A',strtotime($val->duration)) }} </td>
                                          <!-- <td><a href="{{url('batch/'.$val->id)}}" class="btn btn-primary btn-xs "><i class="fas fa-eye"></i> </a> </td> -->
