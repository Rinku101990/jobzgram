...
.yl-breadcrumb-section {
      ...
      <!-- Start of breadcrumb section
         ...
         <section id="yl-breadcrumb" class="yl-breadcrumb-section position-relative" style="">
            ...
            <div class="row" >
               ...
               <h2 style="color:#fff">Favourite Blogs</h2>
                </div>
                <div class="col-md-6 col-sm-6 hidden">
                    <ul class="breadcrumb pull-right" style="background:transparent;    float: right;margin-bottom: 0px;">
                       ...
                       <li class="active"><a href="#" style="color:#fff">Favourite Blogs</a></li>
                                                                                            </ul>
                </div>
            </div>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0 h6">Favourite Blogs</h5>
        </div>
        <div class="card-body">
                            ...
                            <table id="example" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="example_info">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="w-10p">Img</th>
                                        <th class="wd-15p">Blog</th>  
                                ...
                                <tbody>
                                          @foreach($favblog as $key=>$st_value)                            
                                     <tr role="row" class="odd">
                                        <td class="sorting_1">{{$key+1}}.</td>
                                        <td><a href="{{url('blog'.'/'.$st_value->getblog->id)}}" style="    color: #0000ff;"><img src="{{url('storage/blog/'.$st_value->getblog->img)}}" style="width:100px;"></a></td>
                                        
                        <td><a href="{{url('blog'.'/'.$st_value->getblog->id)}}" style="    color: #0000ff;">{{$st_value->getblog->title}}</a></td>
                        <td>{{$st_value->getblog->author}}</td>
