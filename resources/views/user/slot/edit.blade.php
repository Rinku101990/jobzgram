...
<section id="yl-breadcrumb" class="yl-breadcrumb-section position-relative" style="">
            ...
            <div class="row" >
               ...
               <h2 style="color:#fff">Edit Slot </h2>
                </div>
                <div class="col-md-6 col-sm-6 hidden">
                    <ul class="breadcrumb pull-right" style="background:transparent;    float: right;margin-bottom: 0px;">
                       ...
                       <li class="active"><a href="#" style="color:#fff">Edit Slot</a></li>
                                                                                            </ul>
                </div>
            </div>
    ...
    <div class="card">
        ...
        {{ Form::open(array('url' => route('slot.update',$slot->id),'method'=>'put')) }}
                    {!! csrf_field() !!}
                        ...
                        <input type="date" class="form-control mb-2" value="{{$slot->slot_date}}" name="slot_date" >
                    ...
                    <div class="col-md-6">
                         ...
                         <input type="time" class="form-control mb-2" placeholder="10:00 AM" value="{{$slot->start_time}}" name="start_time" >
                         @error('start_time')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-md-6">
                         ...
                         <input type="time" class="form-control mb-2" placeholder="10:00 AM" name="end_time" value="{{$slot->end_time}}" >
                         @error('end_time')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-md-6">
                      ...
                      <select class="form-control mb-2" name="status">
                          ...
                          <option value="not_available" @if($slot->status=='not_available') selected @endif>Not Available</option>
