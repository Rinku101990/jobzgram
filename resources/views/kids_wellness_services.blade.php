...
<!-- Start of breadcrumb section
   ...
   <section id="yl-breadcrumb" class="yl-breadcrumb-section position-relative" style="padding: 0">
            ...
            <img src="{{ asset('assets/images/page/kids_wellness.jpg')}}" title="Parenting forum " style="width: 100%">
          </section>
                     ...
                     <div class="col-lg-12">
                        <div class="about-page-about-text">
                           <div class="yl-section-title  yl-headline yl-title-style-two position-relative" style="    max-width: 100%;">
                              <p class="title-watermark">Kids Wellness Services </p>
                              <span>About Kids Wellness Services</span>
                           </div>
                           <br>
                           ...
                           <div class="yl-feature-text yl-headline pera-content" align="justify">
                              <center><img src="assets/images/worse_counseling.jpg" style="border: 3px solid #FFA300;"></center>
                           </div>
