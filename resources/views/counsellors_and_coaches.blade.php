   ...
   <div class="container">
      <div class="row" >
         <div class="col-md-6 col-sm-6">
            <h2 style="color:#fff">Coaches & Counselors</h2>
         </div>
         <div class="col-md-6 col-sm-6 hidden">
            <ul class="breadcrumb pull-right" style="background:transparent;    float: right;margin-bottom: 0px;">
               ...
               <li class="active"><a href="#" style="color:#fff">Coaches & Counselors</a></li>
            </ul>
         </div>
      </div>
   </div>
                     ...
                     <div class="sort-by-bar row no-gutters mt-3">
                        <div class="col-lg-6 col-md-6">
                           <div class="sort-by-box">
                              <form id="search-form" action="{{url('counsellors-and-coaches')}}" method="GET">
