            ...
            <div class="col-lg-12">
               <div class="about-page-about-text">
                  <div class="yl-course-more-btn text-center " style="margin: 0;width: 230px;">
                     <a href="{{ url('live-demo')}}?program=Crafting My Live">Live for demo     <i class="fas fa-arrow-right"></i></a>
                  </div>
                  <br/>
                  <br/>
                  ...
                  <br>
                  <div class="yl-course-more-btn text-center " style="margin: 0;width: 230px;">
                     <a href="{{ url('live-for-program') }}?amount={!! $Program->fees !!}&program=Crafting My Live"> Enroll for the program<i class="fas fa-arrow-right"></i></a>
                  </div>
               </div>
            </div>
         </div>
