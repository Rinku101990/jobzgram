...
<div class="container-fluid flex-grow-1 container-p-y">
    <h4 class="font-weight-bold py-3 mb-0">Teachers</h4>
    <div class="text-muted small mt-0 mb-4 d-block breadcrumb">
       ...
       <div class="card">
        <h6 class="card-header bg-dark text-white">Teacher List</h6>
            ...
            <table class="datatables-demo table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr class="odd gradeX">
                        ...
                        <td>
                            <a href="{{url('admin/teacher/'.$row->id)}}" class="btn btn-primary btn-xs "><i class="feather icon-eye"></i> </a> 
