...
<div class="container-fluid flex-grow-1 container-p-y">
    <h4 class="font-weight-bold py-3 mb-0">Counsellors</h4>
    <div class="text-muted small mt-0 mb-4 d-block breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}"><i class="feather icon-home"></i></a></li>
            <li class="breadcrumb-item">Counsellors</li>
            <li class="breadcrumb-item active">Counsellor List</li>
        </ol>
    </div>

       <div class="card">
        <h6 class="card-header bg-dark text-white">Counsellor List</h6>
        ...
        <div class="card-datatable table-responsive">
            <table class="datatables-demo table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    @if($row->registerAs=='child_counsellor')
                    <tr class="odd gradeX">
                        <td>{{$key+1}}</td>
                        ...
                        <td>
                            <a href="{{url('admin/counsellors/'.$row->id)}}" class="btn btn-primary btn-xs "><i class="feather icon-eye"></i> </a> 
