...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="text-muted small mt-0 mb-4 d-block breadcrumb">
       ...
       <div class="card">
        <h6 class="card-header bg-dark text-white">FAQ List
        <a href="{{url('admin/faq/create')}}" class="btn btn-success btn-sm  btn-round float-right" ><i class="feather icon-plus"></i> Add FAQ</a>
        </h6>
            ...
            <table class="datatables-demo table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr class="odd gradeX">
                        ...
                        <td>
                            <a href="{{url('admin/faq/'.$row->id.'/edit')}}" class="btn btn-info btn-xs"><i class="feather icon-edit"></i> </a> 
