                ...
                <form class="form-horizontal form-label-left" action="{{ url('admin/profile_update') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="url" class="form-control" placeholder="Enter Email Id" name="email" value="{{auth()->guard('admin')->user()->email }}" disabled>
                            <div class="clearfix"></div>
                        </div>
                    </div>
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <div class="clearfix"></div> 
                            <input type="hidden" name="img_prev" value="{{ $user=auth()->guard('admin')->user()->profileImage}}" />
                            @php if(Storage::disk('public')->exists('/profile/'.$user) && $user !=''){  @endphp
                                <div class="col-md-6" > 
                                <div class="form-group">
                                    <div class="form-line" style="border-bottom: 0px">
                                    <img height="84"  width="165" src="<?=url('/storage/profile/').'/'.$user ?>">
                                    </div>
                                </div>
                                </div>
                            @php } @endphp  
