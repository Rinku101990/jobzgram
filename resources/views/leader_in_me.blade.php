      ...
      <!-- Start of about us  section
         ...
         <section id="about-page-about" class="about-page-about-section">
            <div class="container">
               ...
               <a href="{{ url('live-demo')}}?program=Leader In Me">Live for demo     <i class="fas fa-arrow-right"></i></a>
            </div>
            <br/>      <br/>
...
@endforeach
               ...
               <br>
                           <div class="yl-course-more-btn text-center " style="margin: 0;width: 230px;">
               <a href="{{ url('live-for-program') }}?amount={!! $Program->fees !!}&program=Leader In Me"> Enroll for the program     <i class="fas fa-arrow-right"></i></a>
            </div>
